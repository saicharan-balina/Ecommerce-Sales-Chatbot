        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4 max-w-md">
              Experience the future of shopping with our AI-powered assistant. Discover premium electronics with personalized recommendations and expert guidance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/products" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">Products</Link></li>
              <li><Link to="/chat" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">AI Assistant</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © 2025 NexTechAI. All rights reserved. Powered by advanced AI technology.
            </p>
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <span className="text-sm text-gray-500">Trusted by 10,000+ customers</span>
